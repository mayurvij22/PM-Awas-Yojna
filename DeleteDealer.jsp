	...
	<section class="wrapper">
		<div class="form-w3layouts">
                            ...
                            <div class="form">
                                <form class="cmxform form-horizontal" action=""  method="post" >
                                    ...
                                    <div class="form-group ">
                                        <label for="dealerEmail" class="control-label col-lg-3">Enter your Email Id</label>
                                        <div class="col-lg-6">
            ...
            <!-- page end-->
				...
				PreparedStatement ps1 = con.prepareStatement("delete from dealersdata where dealerEmail=?");
