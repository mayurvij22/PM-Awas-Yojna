                                ...
                                <form class="cmxform form-horizontal"  >
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                           <center>  <button class="btn btn-default" type="button"> <a href="First.html"> Go to Menu</a></button> </center> 
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2017 ADMIN. All rights reserved | Design by <a href="#">Mayur Patil</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
