	...
	<section class="wrapper">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal" action=""  method="" >

                                    <div class="form-group ">
                                        <label for="dealerEmail" class="control-label col-lg-3">Enter your Email</label>
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="dealerEmail" type="email">
                                        </div>
                                    </div>
      ...
      <table class="table" ui-jq="footable" ui-options='      {
        ...
        <thead style=background-color="red">
          <tr>
            <th data-breakpoints="xs">dealerId</th>
            <th>dealerEmail</th>
            <th>dealerpwd</th>
            <th data-breakpoints="xs">dealerShopName</th>
           
            <th data-breakpoints="xs sm md" >dealerContactNo</th>
              <th data-breakpoints="xs">dealerRegion</th>
              <th data-breakpoints="xs">dealerCity</th>
          </tr>
        </thead>
				...
				PreparedStatement ps1 = con.prepareStatement("select * from dealersdata where dealerEmail=?");
				...
				while(rs.next())
				{
					%>
					  <tr>
				<td><%=rs.getInt("dealerId")%></td>
				<td> <%=rs.getString("dealerEmail")%></td>
				<td> <%=rs.getString("dealerpwd")%></td>
				<td> <%=rs.getString("dealerShopName")%></td>
				<td> <%=rs.getString("dealerContactNo")%></td>
				<td> <%=rs.getString("dealerRegion")%></td>
				<td> <%=rs.getString("dealerCity")%></td>
				<td><a href="DeleteDealer.jsp?dealerEmail<%=rs.getString(2)%>">delete</a></td>
				</tr>
